...
<body>
	...
	<!-- ==================== I RE-ARRANGED THE CODES AND MADE THEM NEATER ==================== -->
	<div class="container-fluid p-0" style="width: 100%;">
		<div class="no-gutters" style='width: 100%;'>
			<div class="card shadowed">
				...
				<h1><strong>Get Daily Updates on Programming Hacks, curated from top websites</strong></h1>
				<p style="font-size: 20px;">Pick a plan below and join over <strong>120,000 companies</strong> that upgrade their Basecamp.</p>
				<hr>
				<h3><strong>Get started with payment that suites you ...</strong></h3>
				<div class="row" style="text-align: center; display: block; margin: auto;">
					<div class="col" style="max-width: 85%; margin: auto;">
						...
						<div class="row" style="margin-top: 20px;">
							...
							<div class="col-md" style="padding: 10px;">
								<div class="card inner">
									<h3><strong>Pay monthly</strong></h3>
									<button class="button" style="margin: 5px 0px;">Choose this plan</button>
									<div class="price-list" id="pl-2">
										<ul>
...
<!--==================== I put the modal scripts that was written here in the js file to make it neater ====================-->
</body>
</html>